...
<head> -> Contains the information about the page which doesn't show up on actual screen. It's for browsers, search engines and social media bots.
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge"> -> This is a legacy tag that forces Internet Explorer to use its latest rendering engine.
    <meta name="viewport" content="width=device-width, initial-scale=1.0"> -> This is the most important tag for mobile. It tells the browser to set the width of the page to the width of the device screen, preventing your site from looking tiny on a phone.
    <title>Document</title> -> This is the text that appears on the browser tab.
</head>
<body>
    -> All the content which we would see or interact on screen would go in between these tags.
</body>
